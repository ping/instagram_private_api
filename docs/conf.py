# -*- coding: utf-8 -*-
#
# instapi documentation build configuration file, created by
...
project = u'instapi'
copyright = u'2017, breuerfelix'
author = u'breuerfelix'
