...
.. code-block:: bash
    ...
    $ pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.5.0

Update your install with the latest release

.. code-block:: bash

    $ pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.5.0 --upgrade
