...
.. code-block:: bash
    ...
    $ pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.5.1

Update your install with the latest release

.. code-block:: bash

    $ pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.5.1 --upgrade
