...
``pip install git+https://git@github.com/ping/instagram_private_api.git@1.5.2``

To update:

``pip install git+https://git@github.com/ping/instagram_private_api.git@1.5.2 --upgrade``
