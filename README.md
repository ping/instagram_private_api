...
``pip install git+https://git@github.com/ping/instagram_private_api.git@1.5.6``

To update:

``pip install git+https://git@github.com/ping/instagram_private_api.git@1.5.6 --upgrade``
