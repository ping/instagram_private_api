...
``pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.3.3``

To update:

``pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.3.3 --upgrade``
