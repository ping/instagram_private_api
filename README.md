...
``pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.2.0``

To update:

``pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.2.0 --upgrade``
