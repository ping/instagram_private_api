...
``pip install git+https://git@github.com/ping/instagram_private_api.git@1.5.1``

To update:

``pip install git+https://git@github.com/ping/instagram_private_api.git@1.5.1 --upgrade``
