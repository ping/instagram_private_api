...
[![Release](https://img.shields.io/badge/release-v1.2.1-orange.svg)](https://github.com/ping/instagram_private_api/releases)
...
``pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.2.1``

To update:

``pip install git+ssh://git@github.com/ping/instagram_private_api.git@1.2.1 --upgrade``
